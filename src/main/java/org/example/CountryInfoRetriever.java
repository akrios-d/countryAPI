...
public class CountryInfoRetriever {
    public static void main(String[] args) {
        ...
        CountryInfoRetriever countryInfoRetriever = new CountryInfoRetriever();

        // Retrieve the list of countries from the REST Countries API
        Countries countries = countryInfoRetriever.retrieveCountriesData();

        if (countries != null) {
            // Task 1: Sort countries by population density in descending order
            List<Country> sortedCountriesByDensity = countryInfoRetriever.sortCountriesByPopulationDensity(countries.getCountryList());
            ...
            Country asianCountry = countryInfoRetriever.findAsianCountryWithMostBorderingDifferentRegion(countries.getCountryList());
